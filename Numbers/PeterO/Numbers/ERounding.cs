...
namespace PeterO.Numbers {
  ...
  public enum ERounding {
    /// <summary>Indicates that rounding will not be used. If
    /// rounding is
    /// required, the rounding operation will report an error.</summary>
    None,

    /// <summary>If there is a fractional part, the number is
    /// rounded to
    /// the closest representable number away from zero.</summary>
    Up,

    /// <summary>The fractional part is discarded (the number
    /// is
    /// truncated).</summary>
    Down,

    /// <summary>Rounded to the nearest number; if the
    /// fractional part is
    ...
    /// <summary>If there is a fractional part and the whole
    /// number part is
    ...
    /// <summary>If there is a fractional part and if the last
    /// digit before
    ...
    /// <summary>For binary floating point numbers, this is the
    /// same as
