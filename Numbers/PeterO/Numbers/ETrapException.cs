...
namespace PeterO.Numbers {
    /// <xmlbegin id="877"/><summary>Exception thrown for arithmetic trap errors. (The "E"
...
public sealed class ETrapException : ArithmeticException {
    ...
    /// <xmlbegin id="878"/><summary>Gets the arithmetic context used during the operation that
  ...
  /// <xmlend/>
    ...
    /// <xmlbegin id="879"/><summary>Gets the defined result of the operation that caused the
    /// trap.</summary>
  ...
  /// <xmlend/>
    ...
    /// <xmlbegin id="880"/><summary>Gets the flag that specifies the kind of error
  ...
  /// <xmlend/>
    ...
    /// <xmlbegin id="881"/><summary>Initializes a new instance of the
