...
namespace PeterO.Numbers {
  ...
  EInteger.One + (EInteger)Int32.MaxValue);
    ...
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='exponent'/> is null.</exception>
    ...
    /// <returns>A context object for arbitrary-precision arithmetic
    /// settings.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='exponentMin'/> is null.</exception>
    ...
    /// <returns>A context object for arbitrary-precision arithmetic
    /// settings.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='bigintPrecision'/> is null.</exception>
