...
namespace PeterO.Numbers {
    ...
    /// </para>
    /// <para>Passing a quiet NaN to any arithmetic operation shown here will
    ///return a
    /// quiet NaN, unless noted otherwise.
    /// </para>
    /// <para>Unless noted otherwise, passing a null arbitrary-precision binary
    ///float
    ...
    /// <para>Instances of this class are immutable, so they are inherently safe
    ///for
    ...
    /// <para>It is not recommended to implement security-sensitive algorithms
    ///using
    /// the methods in this class, for several reasons:
    /// </para>
    /// <list>
    /// <item><c>EFloat</c> objects are immutable, so they can't be modified, and
    ///the memory they
    ...
    /// are not guaranteed to be "constant-time" (non-data-dependent) for all
    ...
    /// derive keying material or cleartext indirectly.
    /// </item>
    /// </list>
    /// <para>Applications should instead use dedicated security libraries to
    ///handle
    /// big numbers in security-sensitive algorithms.
    /// </para></summary>
  ...
  IEquatable<EFloat> {
    ...
    /// <summary>Gets this object's exponent. This object's value will be an
    ///integer if the
    /// exponent is positive or zero.</summary><value>This object's exponent. This
    ///object' s value will be an integer if the
    ...
    ///infinity or
    /// NaN).</summary><value><c>true</c> if this object is finite (not infinity or
    ///NaN); otherwise,
    /// <c>false</c> .
    /// </value>
    ...
    /// negative zero.</summary><value><c>true</c> if this object is negative,
    ///including negative zero; otherwise,
    /// <c>false</c> .
    /// </value>
    ...
    /// <c>false</c> .
    /// <c>true</c> if this object' s value equals 0; otherwise,
    /// <c>false</c> .
    /// </value>
    public bool IsZero {
      get {
    ...
    /// <summary>Gets this object's unscaled value, or mantissa, and makes it
    ///negative if
    /// this obejct is negative. If this value is not-a-number (NaN), that value's
    /// absolute value is the NaN's "payload" (diagnostic
    ///information).</summary><value>This object' s unscaled value. Will be
    ///negative if this object's value is
    ...
    ///zero.</summary><value>This value's sign: -1 if negative; 1 if positive; 0 if
    ///zero.
    /// </value>
    public int Sign {
      get {
    ...
    /// <summary>Gets the absolute value of this object's unscaled value, or
    ///mantissa. If
    /// this value is not-a-number (NaN), that value is the NaN's "payload"
    /// (diagnostic information).</summary><value>The absolute value of this
    ///object's unscaled value.
    /// </value>
    ...
    ///number.</summary><returns>An arbitrary-precision binary floating-point
    ///number.
    /// </returns>
    public EFloat Copy() {
    ...
    ///(significand).</summary><param name='mantissaSmall'>Desired value for the
    ///mantissa.
    ...
    /// <summary>Creates a number with the value exponent*2^mantissa
    ///(significand).</summary><param name='mantissa'>Desired value for the
    ///mantissa.
    ...
    /// <summary>Creates a not-a-number arbitrary-precision binary floating-point
    ///number.</summary><param name='diag'>An integer, 0 or greater, to use as
    ///diagnostic information associated with
    /// this object. If none is needed, should be zero. To get the diagnostic
    /// information from another arbitrary-precision binary floating-point number,
    /// use that object's
    /// <c>UnsignedMantissa</c> property.
    ...
    /// use that object's
    /// <c>UnsignedMantissa</c> property.
    /// </param><param name='signaling'>Whether the return value will be signaling
    ///(true) or quiet (false).
    /// </param><param name='negative'>Whether the return value is negative.
    /// </param><param name='ctx'>An arithmetic context to control the precision
    ///(in bits) of the diagnostic
  ...
  ArgumentException("Diagnostic information must be 0 or greater, was: " +
    ...
    /// <summary>Converts an arbitrary-precision integer to the same value as a
    ///binary
    /// float.</summary><param name='bigint'>An arbitrary-precision integer.
    /// </param><returns>An arbitrary-precision binary floating-point number.
    /// </returns>
    ...
    /// lower case.
    /// </para>
    /// <para>All characters mentioned above are the corresponding characters in
    ///the
    ...
    /// <paramref name='str'/>
    /// is a text string.
    /// </param><param name='offset'>A zero-based index showing where the desired
    ///portion of
    /// <paramref name='str'/>
    /// begins.
    /// </param><param name='length'>The length, in code units, of the desired
    ///portion of
    /// <paramref name='str'/>
    /// (but not more than
    /// <paramref name='str'/>
    ...
    /// </param><returns>The parsed number, converted to arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns><exception cref='System.ArgumentNullException'>The parameter
    /// <paramref name='str'/>
    /// is null.
    /// </exception><exception cref='System.ArgumentException'>Either
    ...
    /// <c>FromString(String, int, int, EContext)</c> method.</summary><param
    ///name='str'>A text string to convert to a binary float.
    /// </param><returns>The parsed number, converted to arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns>
    ...
    /// <c>FromString(String, int, int, EContext)</c> method.</summary><param
    ///name='str'>A text string to convert to a binary float.
    /// </param><param name='ctx'>An arithmetic context specifying the precision,
    ///rounding, and exponent
    ...
    /// <summary>
    /// Creates a binary float from a text string that represents a number. For
    /// more information, see the
    /// <c>
    ...
    /// </param>
    /// <param name='offset'>
    /// A zero-based index showing where the desired portion of
    /// <paramref name='str'/>
    /// begins.
    /// </param>
    /// <param name='length'>
    /// The length, in code units, of the desired portion of
    /// <paramref name='str'/>
    /// (but not more than
    /// <paramref name='str'/>
    /// 's length).
    ...
    ///numbers.</summary><param name='first'>The first value to compare.
    /// </param><param name='second'>The second value to compare.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    ...
    /// <summary>Gets the greater value between two binary floating-point
    ///numbers.</summary><param name='first'>An arbitrary-precision binary
    ///floating-point number.
    /// </param><param name='second'>Another arbitrary-precision binary
    ///floating-point number.
    /// </param><returns>The greater of the two arbitrary-precision numbers.
    /// </returns>
    public static EFloat Max(
      EFloat first,
      EFloat second) {
    ...
    /// <summary>Gets the greater value between two values, ignoring their signs.
    ///If the
    /// absolute values are equal, has the same effect as Max.</summary><param
    ///name='first'>The first value to compare.
    /// </param><param name='second'>The second value to compare.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    ...
    ///the
    /// absolute values are equal, has the same effect as Min.</summary><param
    ///name='first'>The first value to compare.
    /// </param><param name='second'>The second value to compare.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    /// </summary>
    /// <param name='ctx'>
    /// An arithmetic context to control the precision, rounding, and exponent
    /// range of the result. If
    /// <c>
    /// HasFlags
    /// </c>
    ...
    /// </param>
    /// <returns>
    /// The constant π rounded to the given precision. Signals FlagInvalid and
    ...
    ///becomes
    /// positive).</summary><returns>An arbitrary-precision binary floating-point
    ///number. Returns signaling NaN
    /// if this value is signaling NaN. (In this sense, this method is similar to
    /// the "copy-abs" operation in the General Decimal Arithmetic Specification,
    ...
    /// <summary>Finds the absolute value of this object (if it's negative, it
    ///becomes
    /// positive).</summary><param name='context'>An arithmetic context to control
    ///the precision, rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited and no rounding is needed.
    /// </param><returns>The absolute value of this object. Signals FlagInvalid and
    ///returns quiet
    ...
    ///arbitrary-precision
    /// integer.</summary><param name='intValue'>The parameter
    /// <paramref name='intValue'/>
    ...
    /// <summary>Multiplies this instance by the value of an arbitrary-precision //
    /// /integer object.</summary><param name='intValue'>The parameter
    /// <paramref name='intValue'/>
    /// is a 32-bit signed integer.
    /// </param><returns>The product of the two numbers.
    /// </returns><example><code>EInteger result = // /
    ...
    /// <summary>Divides this instance by the value of an arbitrary-precision
    ///integer. The
    ...
    /// both are negative.</summary><param name='intValue'>The divisor.
    /// </param><returns>The quotient of the two objects.
    /// </returns><exception cref='System.DivideByZeroException'>Attempted to
    ///divide by zero.
    /// </exception>
    ...
    ///result.</summary><param name='otherValue'>An arbitrary-precision binary
    ///floating-point number.
    ...
    ///exponent is
    /// set to the lower of the exponents of the two operands.</summary><param
    ///name='otherValue'>The number to add to.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ...
    /// <para>
    /// This method is not consistent with the Equals method because two
    ...
    /// </para>
    /// <para>
    /// If this object or the other object is a quiet NaN or signaling NaN, this
    ...
    /// </para></summary><param name='other'>An arbitrary-precision binary
    ///floating-point number.
    /// </param><param name='ctx'>An arithmetic context. The precision, rounding,
    ///and exponent range are
    /// ignored. If
    /// <c>HasFlags</c> of the context is true, will store the flags resulting from
    ///the operation
    /// (the flags are in addition to the pre-existing flags). Can be null.
    /// </param><returns>Quiet NaN if this object or the other object is NaN, or 0
    ///if both objects
    ...
    /// <summary>Compares the values of this object and another object, imposing a
    ///total
    ...
    /// </item>
    /// </list></summary><param name='other'>An arbitrary-precision binary float to
    ///compare with this one.
    /// </param><param name='ctx'>An arithmetic context. Flags will be set in this
    ///context only if
    /// <c>HasFlags</c> and
    /// <c>IsSimplified</c> of the context are true and only if an operand needed
    ///to be rounded
    /// before carrying out the operation. Can be null.
    /// </param><returns>The number 0 if both objects have the same value, or -1 if
    ///this object is
    ...
    /// <summary>Compares the values of this object and another object, imposing a
    ///total
    /// ordering on all possible values (ignoring their signs). In this method:
    /// <list>
    /// <item>For objects with the same value, the one with the higher exponent has
    /// a greater "absolute value".
    /// </item>
    ...
    ///to be rounded
    /// before carrying out the operation. Can be null.
    /// </param><returns>The number 0 if both objects have the same value (ignoring
    ///their signs),
    /// or -1 if this object is less than the other value (ignoring their signs),
    /// or 1 if this object is greater (ignoring their signs). Does not signal
    /// flags if either value is signaling NaN.
    /// </returns>
    ...
    /// <summary>Compares the absolute values of this object and another object,
    ///imposing a
    ...
    /// <summary>Returns a number with the same value as this one, but copying the
    ///sign
    ...
    ///object.).</summary><param name='other'>A number whose sign will be copied.
    /// </param><returns>An arbitrary-precision binary floating-point number.
    /// </returns><exception cref='System.ArgumentNullException'>The parameter
    /// <paramref name='other'/>
    /// is null.
    ...
    ///result. When
    /// possible, the result will be exact.</summary><param name='divisor'>The
    ///number to divide by.
    /// </param><returns>The quotient of the two numbers. Returns infinity if the
    ///divisor is 0 and
    ...
    /// arbitrary-precision binary floating-point number. The preferred exponent
    /// for the result is this object's exponent minus the divisor's
    ///exponent.</summary><param name='divisor'>The number to divide by.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ...
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited and no rounding is needed.
    /// </param><returns>The quotient of the two objects. Signals FlagDivideByZero
    ///and returns
    ...
    ///RemainderNaturalScale.</summary><param name='divisor'>The number to divide
    ///by.
    /// </param><returns>A 2 element array consisting of the quotient and remainder
    ///in that order.
    /// </returns>
    ...
    ///RemainderNaturalScale.</summary><param name='divisor'>The number to divide
    ///by.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ///precision, rounding, and
    ...
    /// <c>HasFlags</c> is true and the integer part of the division result doesn't
    ///fit the
    ...
    /// <summary>Divides two arbitrary-precision binary floating-point numbers, and
    ///gives a
    /// particular exponent to the result.</summary><param name='divisor'>The
    ///number to divide by.
    /// </param><param name='desiredExponentSmall'>The desired exponent. A negative
    ///number places the cutoff point to the
    ...
    /// binary digit places to round to). A positive number places the cutoff
    /// point to the left of the usual radix point.
    /// </param><param name='rounding'>The rounding mode to use if the result must
    ///be scaled down to have the
    ...
    /// particular exponent to the result.</summary><param name='divisor'>The
    ///number to divide by.
    /// </param><param name='exponent'>The desired exponent. A negative number
    ///places the cutoff point to the
    /// right of the usual radix point (so a negative number means the number of
    /// binary digit places to round to). A positive number places the cutoff
    /// point to the left of the usual radix point.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ...
    /// particular exponent to the result.</summary><param name='divisor'>The
    ///number to divide by.
    /// </param><param name='desiredExponent'>The desired exponent. A negative
    ///number places the cutoff point to the
    /// right of the usual radix point (so a negative number means the number of
    /// binary digit places to round to). A positive number places the cutoff
    /// point to the left of the usual radix point.
    ...
    /// set to this value's exponent minus the divisor's exponent.</summary><param
    ///name='divisor'>The number to divide by.
    /// </param><returns>The integer part of the quotient of the two objects.
    ///Signals
    ...
    /// to this value's exponent minus the divisor's exponent.</summary><param
    ///name='divisor'>An arbitrary-precision binary floating-point number.
    /// </param><param name='ctx'>The parameter
    /// <paramref name='ctx'/>
    /// is an EContext object.
    /// </param><returns>The integer part of the quotient of the two objects.
    ...
    /// <summary>Divides this object by another object, and returns the integer
    ///part of the
    /// result, with the exponent set to 0.</summary><param name='divisor'>The
    ///number to divide by.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ///precision. The rounding and
    /// exponent range settings of this context are ignored. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited.
    /// </param><returns>The integer part of the quotient of the two objects. The
    ///exponent will be
    ...
    ///with the
    /// same exponent as this object (the dividend).</summary><param
    ///name='divisor'>The number to divide by.
    /// </param><param name='rounding'>The rounding mode to use if the result must
    ///be scaled down to have the
    /// same exponent as this value.
    /// </param><returns>The quotient of the two numbers. Signals FlagDivideByZero
    ///and returns
    /// infinity if the divisor is 0 and the dividend is nonzero. Signals
    /// FlagInvalid and returns not-a-number (NaN) if the divisor and the dividend
    /// are 0. Signals FlagInvalid and returns not-a-number (NaN) if the rounding
    ...
    /// <summary>Determines whether this object's mantissa (significand), exponent,
    ///and
    /// properties are equal to those of another object. Not-a-number values are
    /// considered equal if the rest of their properties are equal.</summary><param
    ///name='other'>An arbitrary-precision binary floating-point number.
    /// </param><returns><c>true</c> if this object's mantissa (significand) and
    ///exponent are equal to those
    ...
    /// an arbitrary-precision binary floating-point number. Not-a-number values
    /// are considered equal if the rest of their properties are
    ///equal.</summary><param name='obj'>The parameter
    /// <paramref name='obj'/>
    ...
    /// <summary>Determines whether this object's mantissa (significand) and
    ///exponent are
    /// equal to those of another object.</summary><param name='otherValue'>An
    ...
    /// <summary>Calculates this object's hash code. No application or process IDs
    ///are used
    /// in the hash code calculation.</summary><returns>A 32-bit signed integer.
    /// </returns>
    ...
    ///negative
    /// infinity.</summary><returns><c>true</c> if this object is positive or
    ...
    ///(NaN).</summary><returns><c>true</c> if this object is not a number (NaN);
    ///otherwise,
    /// <c>false</c> .
    /// </returns>
    public bool IsNaN() {
    ...
    ///infinity.</summary><returns><c>true</c> if this object is negative infinity;
    ///otherwise,
    /// <c>false</c> .
    /// </returns>
    ...
    ///infinity.</summary><returns><c>true</c> if this object is positive infinity;
    ///otherwise,
    /// <c>false</c> .
    /// </returns>
    ...
    ///not-a-number value.</summary><returns><c>true</c> if this object is a quiet
    ///not-a-number value; otherwise,
    /// <c>false</c> .
    /// </returns>
    ...
    ///not-a-number
    /// value.</summary><returns><c>true</c> if this object is a signaling
    ///not-a-number value; otherwise,
    /// <c>false</c> .
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// Ln(this object). Signals the flag FlagInvalid and returns NaN if this
    ...
    /// </summary>
    /// <param name='places'>
    /// The number of binary digit places to move the radix point to the left. If
    /// this number is negative, instead moves the radix point to the right by
    /// this number's absolute value.
    /// </param>
    /// <returns>
    /// A number whose exponent is decreased by &#x22;places&#x22;, but not to
    /// more than 0.
    /// </returns>
    ...
    ///moved to
    /// the left.</summary><param name='places'>The number of binary digit places
    ///to move the radix point to the left. If
    /// this number is negative, instead moves the radix point to the right by
    /// this number's absolute value.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    /// the left.
    /// </summary>
    /// <param name='bigPlaces'>
    /// The number of binary digit places to move the radix point to the left. If
    /// this number is negative, instead moves the radix point to the right by
    /// this number's absolute value.
    /// </param>
    /// <returns>
    /// A number whose exponent is decreased by &#x22;bigPlaces&#x22;, but not to
    /// more than 0.
    /// </returns>
    ...
    /// <summary>Returns a number similar to this number but with the radix point
    ///moved to
    /// the left.</summary><param name='bigPlaces'>The number of binary digit
    ///places to move the radix point to the left. If
    /// this number is negative, instead moves the radix point to the right by
    /// this number's absolute value.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    /// </summary>
    /// <param name='places'>
    /// The number of binary digit places to move the radix point to the right. If
    /// this number is negative, instead moves the radix point to the left by this
    /// number's absolute value.
    /// </param>
    /// <returns>
    /// A number whose exponent is increased by &#x22;places&#x22;, but not to
    /// more than 0.
    /// </returns>
    ...
    /// <summary>Returns a number similar to this number but with the radix point
    ///moved to
    /// the right.</summary><param name='places'>The number of binary digit places
    ///to move the radix point to the right. If
    /// this number is negative, instead moves the radix point to the left by this
    /// number's absolute value.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    /// </param>
    /// <returns>
    /// A number whose exponent is increased by &#x22;bigPlaces&#x22;, but not to
    /// more than 0.
    /// </returns>
    ...
    /// <summary>Returns a number similar to this number but with the radix point
    ///moved to
    /// the right.</summary><param name='bigPlaces'>The number of binary digit
    ///places to move the radix point to the right. If
    /// this number is negative, instead moves the radix point to the left by this
    /// number's absolute value.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    ///exponent will
    /// be the sum of the exponents of the two binary floating-point
    ///numbers.</summary><param name='otherValue'>Another binary float.
    /// </param><returns>The product of the two binary floating-point numbers.
    /// </returns>
    ...
    /// <summary>Multiplies two binary floating-point numbers. The resulting scale
    ///will be
    ...
    /// negative if they have different signs.</summary><param name='op'>Another
    ///binary float.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    ...
    ///float.</summary><param name='multiplicand'>The value to multiply.
    ...
    ///value.</summary><param name='op'>The value to multiply.
    /// </param><param name='augend'>The value to add.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    ...
    /// reversed.</summary><returns>An arbitrary-precision binary floating-point
    ///number. If this value is
    /// positive zero, returns negative zero. Returns signaling NaN if this value
    ...
    ///the
    /// sign reversed.</summary><param name='context'>An arithmetic context to
    ///control the precision, rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited and rounding isn't needed.
    /// </param><returns>An arbitrary-precision binary floating-point number. If
    ///this value is
    /// positive zero, returns positive zero. Signals FlagInvalid and returns
    ...
    /// </summary>
    /// <param name='ctx'>
    /// An arithmetic context object to control the precision and exponent range
    ...
    /// </param>
    /// <returns>
    /// Returns the smallest value that's greater than the given value.Signals
    ...
    /// <summary>Finds the next value that is closer to the other object's value
    ///than this
    /// object's value. Returns a copy of this value with the same sign as the
    /// other value if both values are equal.</summary><param name='otherValue'>An
    ///arbitrary-precision binary float that the return value will approach.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ...
    ///from the
    /// operation (the flags are in addition to the pre-existing flags).
    /// </param><returns>Returns the next value that is closer to the other object'
    ///s value than
    ...
    /// </summary>
    /// <param name='ctx'>
    /// A context for controlling the precision, rounding mode, and exponent
    ...
    /// <summary>Raises this object's value to the given exponent.</summary><param
    ///name='exponent'>An arbitrary-precision binary float expressing the exponent
    ///to raise this
    /// object's value to.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    ...
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited and rounding isn't needed.
    /// </param><returns>This^exponent. Signals the flag FlagInvalid and returns
    ///NaN if this object
    ...
    /// <summary>Raises this object's value to the given exponent.</summary><param
    ///name='exponentSmall'>The exponent to raise this object's value to.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ...
    /// <summary>Raises this object's value to the given exponent.</summary><param
    ///name='exponentSmall'>The exponent to raise this object's value to.
    /// </param><returns>This^exponent. Returns not-a-number (NaN) if this object
    ///and exponent are
    /// both 0.
    /// </returns>
    ...
    /// not-a-number (NaN).</summary><returns>An arbitrary-precision integer.
    /// </returns>
    ...
    /////
    /// /of binary digit places, since it can fail if the difference between
    /// this value's exponent and the desired exponent is too big, depending on
    /// the maximum precision. If rounding to a number of binary digit places is
    /// desired, it's better to use the RoundToExponent and RoundToIntegral
    /// methods instead.
    /// </para>
    /// <para><b>Remark:</b> This method can be used to implement fixed-point //
    ////binary arithmetic,
    /// in which each binary float has a fixed number of digits after the radix
    ...
    /// EContext.ForPrecision(25) // 25-digit precision);</code> <para>A //
    ...
    /// arithmetic".
    /// </para></summary><param name='desiredExponent'>The desired exponent for the
    ////// result. The exponent is the number of
    ...
    /// integer.
    /// </param><param name='ctx'>An arithmetic context to control precision and
    ...
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the default rounding mode is HalfEven.
    /// </param><returns>A binary float with the same value as this object but with
    ////// the
    /// exponent changed. Signals FlagInvalid and returns not-a-number (NaN) if
    /// this object is infinity, if the rounded result can't fit the given
    ...
    /// precision);</code> <para>A fixed-point binary arithmetic in which no digits
    ///// /come after the
    /// radix point (a desired exponent of 0) is considered an "integer
    /// arithmetic".
    /// </para></summary><param name='desiredExponentInt'>The desired exponent for
    ////// the result. The exponent is the number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    /// example, -3 means round to the thousandth (10^-3, 0.0001), and 3 means
    /// round to the thousand (10^3, 1000). A value of 0 rounds the number to an
    ...
    /// </para></summary><param name='otherValue'>A binary float containing the
    ///desired exponent of the result. The mantissa
    ...
    /// <summary>Returns an object with the same numerical value as this one but
    ///with
    /// trailing zeros removed from its mantissa (significand). For example, 1.00
    /// becomes 1.
    /// <para>If this object's value is 0, changes the exponent to 0.
    /// </para></summary><param name='ctx'>An arithmetic context to control the
    ///precision, rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the precision is unlimited and rounding isn't needed.
    /// </param><returns>This value with trailing zeros removed. Note that if the
    ///result has a very
    ...
    ///arbitrary-precision
    /// binary floating-point numbers. The remainder is the value that remains
    ...
    /// as this object's value.</summary><param name='divisor'>An
    ///arbitrary-precision binary floating-point number.
    /// </param><param name='ctx'>The parameter
    /// <paramref name='ctx'/>
    /// is an EContext object.
    /// </param><returns>The remainder of the two numbers. Signals FlagInvalid and
    ///returns
    ...
    /// <c>"this" - (("this" / "divisor") * "divisor")</c> .</summary><param
    ///name='divisor'>The number to divide by.
    /// </param><returns>An arbitrary-precision binary floating-point number.
    /// </returns>
    ...
    ///(("this" /
    /// "divisor") * "divisor").</summary><param name='divisor'>The number to
    ///divide by.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ///precision, rounding, and
    /// exponent range of the result. This context will be used only in the
    ...
    ///function.</summary><param name='divisor'>The number to divide by.
    /// </param><param name='ctx'>An arithmetic context object to control the
    ///precision. The rounding and
    ...
    /// </param><returns>The distance of the closest multiple. Signals FlagInvalid
    ///and returns
    ...
    ///rounded to a
    /// new exponent if necessary. The resulting number's Exponent property will
    /// not necessarily be the given exponent; use the Quantize method instead to
    /// give the result a particular exponent.</summary><param name='exponent'>The
    ///minimum exponent the result can have. This is the maximum number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    /// example, -3 means round to the thousandth (10^-3, 0.0001), and 3 means
    /// round to the thousand (10^3, 1000). A value of 0 rounds the number to an
    ...
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the default rounding mode is HalfEven.
    /// </param><returns>A binary float rounded to the closest value representable
    ///in the given
    ...
    /// exponent must be changed to the given exponent when rounding, and the
    /// given exponent is outside of the valid range of the arithmetic context.
    /// </returns>
    ...
    /// new exponent if necessary. The resulting number's Exponent property will
    /// not necessarily be the given exponent; use the Quantize method instead to
    /// give the result a particular exponent.</summary><param
    ///name='exponentSmall'>The minimum exponent the result can have. This is the
    ///maximum number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    /// example, -3 means round to the thousandth (10^-3, 0.0001), and 3 means
    ...
    /// inexact. The resulting number's Exponent property will not necessarily be
    /// the given exponent; use the Quantize method instead to give the result a
    /// particular exponent.</summary><param name='exponent'>The minimum exponent
    ///the result can have. This is the maximum number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    /// example, -3 means round to the thousandth (10^-3, 0.0001), and 3 means
    /// round to the thousand (10^3, 1000). A value of 0 rounds the number to an
    ...
    /// the result a particular exponent.</summary><param name='exponent'>The
    ///minimum exponent the result can have. This is the maximum number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    ...
    /// </param><param name='rounding'>Desired mode for rounding this object's
    ///value.
    /// </param><returns>A binary number rounded to the closest value representable
    ///in the given
    /// precision.
    /// </returns>
    public EFloat RoundToExponentExact(
 ...
 EContext.Unlimited.WithRounding(rounding));
    ...
    /// <summary>Returns a binary float with the same value as this object but
    ///rounded to
    /// the given exponent represented as a 32-bit signed integer, and signals an
    ...
    ///exponent.</summary><param name='exponentSmall'>The minimum exponent the
    ///result can have. This is the maximum number of
    /// fractional digits in the result, expressed as a negative number. Can also
    /// be positive, which eliminates lower-order places from the number. For
    /// example, -3 means round to the thousandth (10^-3, 0.0001), and 3 means
    /// round to the thousand (10^3, 1000). A value of 0 rounds the number to an
    ...
    /// The resulting number's Exponent property will not necessarily be 0; use
    /// the Quantize method instead to give the result an exponent of
    ///0.</summary><param name='ctx'>An arithmetic context to control the
    ///precision, rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags). Can be
    /// null, in which case the default rounding mode is HalfEven.
    /// </param><returns>A binary float rounded to the closest integer
    ...
    /// <c>FlagInexact</c> or
    /// <c>FlagRounded</c> flags. The resulting number's Exponent property will not
    ///necessarily be
    /// 0; use the Quantize method instead to give the result an exponent of
    ///0.</summary><param name='ctx'>An arithmetic context to control precision and
    ///rounding of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    ...
    ///inexact.</summary><param name='ctx'>An arithmetic context to control the
    ///precision, rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    ...
    /// an integer, without adding the
    /// <c>FlagInexact</c> or
    /// <c>FlagRounded</c> flags.</summary><param name='ctx'>An arithmetic context
    ///to control precision and rounding of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ///from the
    /// operation (the flags are in addition to the pre-existing flags), except
    /// that this function will never add the
    ...
    ///adjusted.</summary><param name='places'>The parameter
    /// <paramref name='places'/>
    /// is a 32-bit signed integer.
    /// </param><returns>An arbitrary-precision binary floating-point number.
    /// </returns>
    ...
    ///adjusted.</summary><param name='bigPlaces'>An arbitrary-precision integer.
    /// </param><param name='ctx'>An arithmetic context to control the precision,
    ///rounding, and exponent
    /// range of the result. If
    /// <c>HasFlags</c> of the context is true, will also store the flags resulting
    ...
    /// </param>
    /// <returns>
    /// The square root. Signals the flag FlagInvalid and returns NaN if this
    ...
    ///and
    /// returns the result.</summary><param name='otherValue'>The number to
    ///subtract from this instance's value.
    /// </param><returns>The difference of the two objects.
    /// </returns>
    ...
    ///number.</summary><returns>This number, converted to a 64-bit floating-point
    ///number.
    /// </returns>
    ...
    ///number.</summary><returns>This number, converted to an arbitrary-precision
    ///decimal number.
    /// </returns>
    ...
    /// integer.</summary><returns>An arbitrary-precision integer.
    /// </returns><exception cref='System.OverflowException'>This object's value
    ///is infinity or not-a-number (NaN).
    /// </exception>
    ...
    ///whether
    /// the value contains a fractional part.</summary><returns>An
    ...
    ///returns
    /// the value of that decimal's ToEngineeringString method.</summary><returns>A
    ///text string.
    /// </returns>
    ...
    /// <summary>Converts this value to an arbitrary-precision decimal
    ///number.</summary><returns>An arbitrary-precision decimal number.
    /// </returns>
    ...
    ///notation.</summary><returns>A text string.
    /// </returns>
    ...
    /// <summary>Returns a string representation of this number's value after
    ///rounding to
    ...
    /// context).</summary><param name='ctx'>An arithmetic context to control
    ///precision (in bits), rounding, and
    ...
    /// </param><returns>Shortest decimal form of this number's value for the given
    ///arithmetic
  ...
  ctx).ToString();
    ...
    /// <para>If this value is a NaN, sets the high bit of the 32-bit floating
    ///point
    ...
    /// </para></summary><returns>The closest 32-bit binary floating-point number
    ///to this value. The return
    ...
    /// <summary>Converts this number's value to a text string.</summary><returns>A
    ///string representation of this object. The value is converted to decimal
    ...
    /// <summary>Returns the unit in the last place. The mantissa (significand)
    ///will be 1
    /// and the exponent will be this number's exponent. Returns 1 with an
    /// exponent of 0 if this number is infinity or not-a-number
    ///(NaN).</summary><returns>An arbitrary-precision binary floating-point
    ///number.
    /// </returns>
    public EFloat Ulp() {
    ...
    /// <summary>This is an internal method.</summary><returns>A 32-bit signed
    ///integer.
    /// </returns>
      public int GetRadix() {
        return 2;
    ...
    /// <summary>This is an internal method.</summary><param name='value'>An
    ///arbitrary-precision binary floating-point number.
    ...
    /// <summary>This is an internal method.</summary><param name='bigint'>An
    ///arbitrary-precision integer.
    ...
    /// <summary>This is an internal method.</summary><param name='num'>An
    ///arbitrary-precision integer.
    ...
    /// <summary>This is an internal method.</summary><param name='bigint'>Another
    ///arbitrary-precision integer.
    ...
    /// <summary>This is an internal method.</summary><param name='mantissa'>The
    ///parameter
  ...
  flags);
    ...
    /// <summary>This is an internal method.</summary><param name='val'>The
    ///parameter
    /// <paramref name='val'/>
    /// is a 32-bit signed integer.
    /// </param><returns>An arbitrary-precision binary floating-point number.
    ...
    /// <summary>Converts this number's value to a byte (from 0 to 255) if it can
    ///fit in a
    /// byte (from 0 to 255) after truncating to an integer.</summary><returns>This
    ///number's value, truncated to a byte (from 0 to 255).
    /// </returns><exception cref='System.OverflowException'>This value is
    ///infinity or not-a-number, or the truncated integer is less
    ...
    /// 255).</summary><returns>This number, converted to a byte (from 0 to 255).
    ///Returns 0 if this value
    ...
    ///value.</summary><returns>This number's value as a byte (from 0 to 255).
    /// </returns><exception cref='System.ArithmeticException'>This value is
    ///infinity or not-a-number, is not an exact integer, or is
    ...
    /// <summary>Converts a byte (from 0 to 255) to an arbitrary-precision binary
    /// floating-point number.</summary><param name='inputByte'>The number to
    ///convert as a byte (from 0 to 255).
    /// </param><returns>This number's value as an arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns>
    ...
    /// <summary>Converts this number's value to a 16-bit signed integer if it can
    ///fit in a
    /// 16-bit signed integer after truncating to an
    ///integer.</summary><returns>This number's value, truncated to a 16-bit signed
    ///integer.
    /// </returns><exception cref='System.OverflowException'>This value is
    ///infinity or not-a-number, or the truncated integer is less
    ...
    /// integer.</summary><returns>This number, converted to a 16-bit signed
    ///integer. Returns 0 if this value
    /// is infinity or not-a-number.
    /// </returns>
    ...
    ///value.</summary><returns>This number's value as a 16-bit signed integer.
    /// </returns><exception cref='System.ArithmeticException'>This value is
    ///infinity or not-a-number, is not an exact integer, or is
    ...
    /// <summary>Converts a 16-bit signed integer to an arbitrary-precision binary
    /// floating-point number.</summary><param name='inputInt16'>The number to
    ///convert as a 16-bit signed integer.
    /// </param><returns>This number's value as an arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns>
    ...
    /// <summary>Converts this number's value to a 32-bit signed integer if it can
    ///fit in a
    /// 32-bit signed integer after truncating to an
    ///integer.</summary><returns>This number's value, truncated to a 32-bit signed
    ///integer.
    /// </returns><exception cref='System.OverflowException'>This value is
    ///infinity or not-a-number, or the truncated integer is less
    ...
    ///value.</summary><returns>This number's value as a 32-bit signed integer.
    /// </returns><exception cref='System.ArithmeticException'>This value is
    ///infinity or not-a-number, is not an exact integer, or is
    ...
    ///arbitrary-precision
    /// binary float.</summary><param name='boolValue'>Either true or false.
    /// </param><returns>The number 1 if
    /// <paramref name='boolValue'/>
    /// is true, otherwise, 0.
    /// </returns>
    ...
    /// <summary>Converts a 32-bit signed integer to an arbitrary-precision binary
    /// floating-point number.</summary><param name='inputInt32'>The number to
    ///convert as a 32-bit signed integer.
    /// </param><returns>This number's value as an arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns>
    ...
    /// <summary>Converts this number's value to a 64-bit signed integer if it can
    ///fit in a
    /// 64-bit signed integer after truncating to an
    ///integer.</summary><returns>This number's value, truncated to a 64-bit signed
    ///integer.
    /// </returns><exception cref='System.OverflowException'>This value is
    ///infinity or not-a-number, or the truncated integer is less
    ...
    /// integer.</summary><returns>This number, converted to a 64-bit signed
    ///integer. Returns 0 if this value
    /// is infinity or not-a-number.
    /// </returns>
    ...
    ///value.</summary><returns>This number's value as a 64-bit signed integer.
    /// </returns><exception cref='System.ArithmeticException'>This value is
    ///infinity or not-a-number, is not an exact integer, or is
    ...
    /// <summary>Converts a 64-bit signed integer to an arbitrary-precision binary
    /// floating-point number.</summary><param name='inputInt64'>The number to
    ///convert as a 64-bit signed integer.
    /// </param><returns>This number's value as an arbitrary-precision binary
    ///floating-point
    /// number.
    /// </returns>
