...
namespace PeterO.Numbers {
  ...
  0);
    ...
    /// <returns>An arbitrary-precision decimal number.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='mantissa'/> or <paramref name='exponent'/> is
    /// null.</exception>
    ...
    /// <returns>An arbitrary-precision decimal number.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='diag'/> is null or is less than 0.</exception>
    ...
    /// number.</param>
    /// <returns>An arbitrary-precision decimal number.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='bigfloat'/> is null.</exception>
  ...
  0);
    ...
    /// other value is null.<para>This implementation returns a positive number if "other" is null, to conform to the .NET definition of CompareTo.  This is the case even in the Java version of this library, for consistency's sake, even though implementations of <c>Comparable.compareTo()</c> in Java ought to throw an exception if they receive a null argument rather than treating null as less or greater than any object.</para></returns>
    ...
    /// than the other value, or a 1 if this object is greater.<para>This implementation returns a positive number if "other" is null, to conform to the .NET definition of CompareTo.  This is the case even in the Java version of this library, for consistency's sake, even though implementations of <c>Comparable.compareTo()</c> in Java ought to throw an exception if they receive a null argument rather than treating null as less or greater than any object.</para></returns>
    ...
    /// their signs).<para>This implementation returns a positive number if "other" is null, to conform to the .NET definition of CompareTo.  This is the case even in the Java version of this library, for consistency's sake, even though implementations of <c>Comparable.compareTo()</c> in Java ought to throw an exception if they receive a null argument rather than treating null as less or greater than any object.</para></returns>
  ...
  EContext.ForRounding(rounding));
    ...
    /// number.</returns>
    /// <exception cref='System.ArgumentNullException'>The parameter <paramref name='ec'/> is null.</exception>
