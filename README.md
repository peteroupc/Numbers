...
- Fix bugs in new EDecimal.FromBoolean and EFloat.FromBoolean methods
...
-    Check for overflow in GetLowBit, GetDigitCount, GetUnsignedBitLength, and GetSignedBitLength methods in EInteger class; deprecate those methods
