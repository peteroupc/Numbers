...
<b>Return Value:</b>
 ...
 `true` if this object is a signaling not-a-number value (which causes an error f the value is passed to any arithmetic operation in this class); otherwise,  `false` .
